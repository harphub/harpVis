...
server <- function(input, output, session) {
  ...
  output$dashboard_rank_hist <- renderPlot({
    shiny::req(dashboard_plots$rank_histogram)
  }, height = "auto", bg = bg_colour)
  output$dashboard_spread_skill <- renderPlot({
    shiny::req(dashboard_plots$spread_skill)
  }, height = "auto", bg = bg_colour)
  output$dashboard_crps <- renderPlot({
    shiny::req(dashboard_plots$crps)
  }, height = "auto", bg = bg_colour)
  output$dashboard_reliability <- renderPlot({
    shiny::req(dashboard_plots$reliability)
  }, height = "auto", bg = bg_colour)
  output$dashboard_roc <- renderPlot({
    shiny::req(dashboard_plots$roc)
  }, height = "auto", bg = bg_colour)
  output$dashboard_brier <- renderPlot({
